...
export function Navbar() {
  const { currentRoute, navigate, selectedTimezone, setTimezone, isMobileMenuOpen, toggleMobileMenu } =
    useUIStore();
  const { appointments } = useAppointmentStore();
  const { profiles, activeProfileId, setActiveProfileId, getActiveProfile } = useFamilyProfilesStore();
  ...
  const currentTzLabel =
    AVAILABLE_TIMEZONES.find((t) => t.value === selectedTimezone)?.label.split(' ')[0] ||
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-20 items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <nav className="hidden lg:flex items-center gap-1.5 ml-2" aria-label="Main Navigation">
              ...
              <div className="relative" ref={servicesRef}>
                ...
                >
                  ...
                  <ChevronDown className={cn("h-4 w-4 text-[#5F6F65] transition-transform duration-200", showServicesDropdown && "rotate-180")} />
                </button>
                    ...
                    <div className="space-y-1">
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          activePath === '/lab-tests' ? 'bg-[#E7EFE3] text-[#1C231F]' : 'hover:bg-[#F4F7F2]'
                        )}
                      >
                        ...
                        <div>
                          <div className="flex items-center gap-1.5">
                            <span className="font-bold text-sm text-[#1C231F]">Diagnostic Lab Tests</span>
                            <span className="text-[10px] font-bold bg-purple-50 text-purple-700 px-1.5 py-0.2 rounded">Home Sample</span>
                          </div>
                          <p className="text-xs text-[#5F6F65] mt-0.5">Blood tests, health packages & reports</p>
                        </div>
                      </button>
                      ...
                      <button
                        ...
                        className={cn(
                          "w-full text-left rounded-xl p-2.5 transition-colors flex items-start gap-3 cursor-pointer",
                          activePath === '/chamber-tracker' ? 'bg-[#E7EFE3] text-[#1C231F]' : 'hover:bg-[#F4F7F2]'
                        )}
                      >
                        ...
                        <div>
                          <div className="flex items-center gap-1.5">
                            <span className="font-bold text-sm text-[#1C231F]">Live Chamber Serial</span>
                            <span className="flex h-2 w-2 rounded-full bg-emerald-600 animate-ping" />
                          </div>
                          <p className="text-xs text-[#5F6F65] mt-0.5">Track your OPD doctor serial number</p>
                        </div>
                      </button>
                      ...
                      <button
                        ...
                        className={cn(
                          "w-full text-left rounded-xl p-2.5 transition-colors flex items-start gap-3 cursor-pointer",
                          activePath === '/family-profiles' ? 'bg-[#E7EFE3] text-[#1C231F]' : 'hover:bg-[#F4F7F2]'
                        )}
                      >
                        ...
                        <div>
                          <span className="font-bold text-sm text-[#1C231F] block">Family Health Circle</span>
                          <p className="text-xs text-[#5F6F65] mt-0.5">Manage parents, spouse & child records</p>
                        </div>
                      </button>
                      ...
                      <button
                        ...
                        className={cn(
                          "w-full text-left rounded-xl p-2.5 transition-colors flex items-start gap-3 cursor-pointer",
                          activePath === '/insurance' ? 'bg-[#E7EFE3] text-[#1C231F]' : 'hover:bg-[#F4F7F2]'
                        )}
                      >
                        ...
                        <div>
                          <div className="flex items-center gap-1.5">
                            <span className="font-bold text-sm text-[#1C231F]">Health Insurance</span>
                            <span className="text-[10px] font-bold bg-amber-50 text-amber-800 px-1.5 py-0.2 rounded">Cashless</span>
                          </div>
                          <p className="text-xs text-[#5F6F65] mt-0.5">Coverage limits & instant claim filing</p>
                        </div>
                      </button>
                      ...
                      <button
                        ...
                        className={cn(
                          "w-full text-left rounded-xl p-2.5 transition-colors flex items-start gap-3 cursor-pointer",
                          activePath === '/dashboard/prescriptions' ? 'bg-[#E7EFE3] text-[#1C231F]' : 'hover:bg-[#F4F7F2]'
                        )}
                      >
                        ...
                        <div>
                          <span className="font-bold text-sm text-[#1C231F] block">Prescriptions & Vault</span>
                          <p className="text-xs text-[#5F6F65] mt-0.5">Doctor advice, dosage & test results</p>
                        </div>
                      </button>
                    </div>
                  </div>
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <div className="relative" ref={profileRef}>
              ...
              >
                <div className={`h-8 w-8 rounded-full flex items-center justify-center text-white text-xs font-black shadow-xs ${activeProfile.avatarBgColor}`}>
                ...
                <ChevronDown className={cn("h-4 w-4 text-[#5F6F65] transition-transform duration-200", showProfileDropdown && "rotate-180")} />
              </button>
              ...
              {showProfileDropdown && (
                <div className="absolute right-0 mt-2 z-50 w-72 rounded-2xl border border-[#C4CFC0] bg-white p-3 shadow-xl animate-in fade-in-50 zoom-in-95 duration-150">
                  <div className="flex items-center justify-between pb-2 mb-2 border-b border-[#E2E8DF]">
                    <div>
                      <span className="text-xs font-bold text-[#1C231F] block">Select Patient</span>
                      <span className="text-[11px] text-[#808D7C]">Book appointments for anyone</span>
                    </div>
                    <button
                      type="button"
                      onClick={() => {
                    ...
                    {profiles.map((p) => (
                      ...
                      >
                        <div className="flex items-center gap-2.5">
                          <span className={`h-7 w-7 rounded-full flex items-center justify-center text-white text-xs font-black shadow-2xs ${p.avatarBgColor}`}>
                            {p.fullName.charAt(0)}
                          </span>
                          <div>
                            <span className="font-bold text-sm block leading-snug">{p.fullName}</span>
                            <span className="text-[11px] text-[#808D7C] font-normal">{p.relationship} • {p.bloodGroup || 'Blood N/A'}</span>
                          </div>
                        </div>
                        {activeProfileId === p.id && (
                  ...
                  <div className="pt-2.5 mt-2 border-t border-[#E2E8DF]">
                    <div className="flex items-center justify-between mb-1.5">
                      ...
                      <span className="text-[11px] font-semibold text-[#1C231F]">{currentTzLabel}</span>
                    </div>
                    <select
        ...
        <div className="border-b border-[#C4CFC0] bg-white px-4 pt-3 pb-8 lg:hidden animate-in slide-in-from-top-4 duration-200 shadow-xl max-h-[85vh] overflow-y-auto">
          ...
          <div className="flex items-center justify-between rounded-2xl bg-[#F0F4ED] p-3.5 mb-4 border border-[#C4CFC0]">
            <div className="flex items-center gap-3">
              <div className={`h-10 w-10 rounded-full flex items-center justify-center text-white font-extrabold text-sm ${activeProfile.avatarBgColor}`}>
                {activeProfile.fullName.charAt(0)}
              </div>
              <div>
                <span className="text-xs text-[#5F6F65] block font-semibold">Active Patient Profile</span>
                <span className="text-base font-extrabold text-[#1C231F] block">{activeProfile.fullName}</span>
              </div>
            </div>
            <Button
              size="sm"
          ...
          <nav className="flex flex-col gap-2">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="block leading-tight">Diagnostic Lab Tests</span>
                  <span className="text-xs text-[#5F6F65] font-normal">Home blood sample collection</span>
                </div>
              </div>
              <ArrowRight className="h-4 w-4 text-[#808D7C]" />
            </button>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="block leading-tight">Live Doctor Serial</span>
                  <span className="text-xs text-[#5F6F65] font-normal">Track your OPD queue number</span>
                </div>
              </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="block leading-tight">Family Health Circle</span>
                  <span className="text-xs text-[#5F6F65] font-normal">Parents & children medical profiles</span>
                </div>
              </div>
              <ArrowRight className="h-4 w-4 text-[#808D7C]" />
            </button>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="block leading-tight">Health Insurance & Claims</span>
                  <span className="text-xs text-[#5F6F65] font-normal">Cashless limits & claim tracking</span>
                </div>
              </div>
              <ArrowRight className="h-4 w-4 text-[#808D7C]" />
            </button>
            ...
            >
              ...
              <span className="rounded-full bg-white/20 px-2.5 py-0.5 text-xs font-bold">SOS</span>
            </button>
