...
export function HomePage() {
  ...
  return (
    <div className="space-y-12 lg:space-y-20 pb-12">
      ...
      {/* 4. HOW BOOKING WORKS */}
      {/* ========================================================================= */}
      <section className="bg-[#F0F4ED]/70 py-16 sm:py-20 border-y border-[#E2E8DF]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            {/* Step 1 */}
            <div className="rounded-2xl border border-[#C4CFC0] bg-white p-6 sm:p-8 shadow-xs relative flex flex-col justify-between">
              <div>
              ...
              <div className="mt-6 pt-4 border-t border-[#E2E8DF] flex items-center gap-2 text-xs font-medium text-[#5F6F65]">
                <BadgeCheck className="h-4 w-4 text-[#5F6F65]" />
